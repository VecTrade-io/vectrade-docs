...
<Info>
**Plan Requirement:** AI Copilot is available on the **Standard** ($19/mo) and **Professional** ($49/mo) plans. Free plan users will see an upgrade prompt when accessing the Copilot page.
</Info>
...
| **Usage Quota** | Circular progress indicator showing remaining monthly token allowance (Standard+ plans) |
...
Your subscription plan determines Copilot access:

| Plan | AI Access | Token Budget | Priority |
|------|-----------|-------------|----------|
| **Free** | Limited (5 prompts/day) | 50K tokens/month | Standard queue |
| **Standard** ($19/mo) | Unlimited prompts | 1M tokens/month | Normal queue |
| **Professional** ($49/mo) | Unlimited prompts | 5M tokens/month | Priority queue |

<Info>
**AI Copilot is available on all plans.** Free plan users get 5 prompts per day to explore AI-powered analysis. Upgrade to Standard or Professional for unlimited usage and higher token budgets.
</Info>

**Quota Indicators (Standard & Professional):**
- **Quota Ring** (sidebar) — Circular progress indicator showing % of monthly token budget consumed
- **Color States:** Green (> 50% remaining) → Amber (10–50% remaining) → Red (< 10% remaining)
- **Exhausted State:** Input bar disables with message: "Monthly token allowance exhausted. Resets on the 1st of next month."

**Reset Schedule:** Token budgets reset on the 1st of each month at midnight UTC.
