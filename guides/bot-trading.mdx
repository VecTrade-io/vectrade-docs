...
- Rate limited to **20 orders/minute** and **120 requests/minute** per key
...
|--------|------|------|-------------|
| POST | `/api/v1/bot/keys` | JWT | Create bot key |
| GET | `/api/v1/bot/keys` | JWT | List your keys |
| DELETE | `/api/v1/bot/keys/{id}` | JWT | Revoke a key |
| GET | `/api/v1/bot/account` | Bot Key | Account info |
| POST | `/api/v1/bot/orders` | Bot Key | Place order |
| DELETE | `/api/v1/bot/orders/{id}` | Bot Key | Cancel order |
| GET | `/api/v1/bot/orders` | Bot Key | List orders |
| GET | `/api/v1/bot/orders/{id}` | Bot Key | Get order |
| GET | `/api/v1/bot/portfolio` | Bot Key | Portfolio |
| GET | `/api/v1/bot/kpi` | Bot Key | Trading KPIs |
