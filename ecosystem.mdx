---
title: Ecosystem
description: The complete VecTrade open-source ecosystem — SDKs, tools, integrations, and community resources.
---

# Ecosystem

VecTrade is a modular financial data platform. Every component is open-source under the [VecTrade-io](https://github.com/VecTrade-io) GitHub organization.
...
|-------------|----------|------|-----------|
| **Production** | `api.vectrade.io` | [docs.vectrade.io](https://docs.vectrade.io) | [app.vectrade.io](https://app.vectrade.io) |
| **UAT** | `api-uat.vectrade.io` | [docs.uat.vectrade.io](https://docs.uat.vectrade.io) | [uat.vectrade.io](https://uat.vectrade.io) |
