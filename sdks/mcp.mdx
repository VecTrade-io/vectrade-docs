...
The VecTrade MCP server provides **40+ financial and trading tools** to any AI IDE that supports the [Model Context Protocol](https://modelcontextprotocol.io/).
...
If your team uses Claude Code skill prompts, add a repo-level skill such as `.claude/skills/vectrade/SKILL.md` with tool-intent patterns:
...
|---|---|---|---|
| Claude Code / Claude Desktop | `~/.config/claude/claude_desktop_config.json` | `~/.config/claude/claude_desktop_config.json` | `%APPDATA%/Claude/claude_desktop_config.json` |
